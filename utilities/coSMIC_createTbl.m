...
%   cfg.desFolder   = destination folder (default: '/data/pt_01888/eegData/DualEEG_coSMIC_processedDataOld/00_settings/')
...
desFolder   = ft_getopt(cfg, 'desFolder', ...
          '/data/pt_01888/eegData/DualEEG_coSMIC_processedDataOld/00_settings/');
...
switch type
  case 'settings'
    ...
    T.Properties.VariableNames = ...
        {'dyad', 'badChanMother', 'badChanChild', 'fsample', ...
         'reference', 'ICAcorrValMother', 'EOGcompMother', 'artMethod', ...
         'artTholdMother', 'artTholdChild', 'artRejectPLV', 'artRejectPSD'};
