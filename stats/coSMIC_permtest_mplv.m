% coSMIC_PERMTEST_MPLV - Using this script one can test if the difference
...
% single dyads. Otherwise one should use coSMIC_PERMTEST_PLV
%
% See also coSMIC_PERMTEST_PLV
