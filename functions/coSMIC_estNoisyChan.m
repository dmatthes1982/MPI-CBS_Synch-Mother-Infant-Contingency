function [ data_out ] = coSMIC_estNoisyChan( data_in )
% coSMIC_ESTNOISYCHAN is a function which is detecting automatically noisy
...
%
% Use as
%   [ data_out ] = coSMIC_estNoisyChan( cfg, data_in )
%
% where input data has to be the result of coSMIC_CONCATDATA.
%
% Reference:
