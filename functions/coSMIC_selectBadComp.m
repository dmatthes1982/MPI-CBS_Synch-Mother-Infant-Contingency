...
% COSMIC_SELECTBADCOMP is a function for exploring previously estimated ICA
...
% COSMIC_DETEOGCOMP are preselected, but it should be visually explored
% too.
%
% Use as
%   [ data_eogcomp ] = coSMIC_selectBadComp( data_eogcomp, data_icacomp )
%
% where the input data_eogcomp has to be the result of COSMIC_DETEOGCOMP
% and data_icacomp the result of COSMIC_ICA
%
