function coSMIC_easyTotalPowerBarPlot( cfg, data )
% coSMIC_EASYTOTALPOWERBARPLOT shows the total power of all available
% channels. The channels are ordered in ascending order and outliers are
% highlighted.
% 
% Use as
%   coSMIC_easyTotalPowerBarPlot( cfg, data)
%
% where the input has to be a result of coSMIC_SELECTBADCHAN.
%
