  ...
  for i = numOfPart
    ...
    if artifactRejection == true
      if artifactAvailable == true
        ...
        data_preproc2 = coSMIC_rejectArtifacts(cfg, data_preproc2);
        fprintf('\n');
      end
    ...
    data_preproc2 = coSMIC_pWelch( cfg, data_preproc2 );                    % calculate power spectral density using Welch's method
